...
- The **Rhino** file should be named: *YYMMDD_DDU_CSC_GrasshopperInterface_RELEASE.3dm*
- The **Grasshopper** file should be named: *YYMMDD_DDU_CSC_GrasshopperInterface_RELEASE.gh*
