...
export default function Footer() {
  return (
      <div className='flex flex-col sm:flex-row gap-2 p-2 border-t text-xs text-center justify-center items-center'>
        <p>
          &copy; {copyright_year()} < a href='https://www.researchgate.net/profile/Max-Eschenbach' target='_blank' className='hover:underline'>Max Benjamin Eschenbach</a> • powered by{' '}
